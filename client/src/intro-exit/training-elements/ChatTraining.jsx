            ...
            <Grid container spacing={{ xs: 2, sm: 3, md: 4 }} sx={{ flexGrow: 1 }}>
                ...
                <Grid item xs={12} md={6}>
                    <Box sx={{ height: '100%', overflowY: 'auto' }}>
                        ...
                        <Typography variant="body1" paragraph>
                            On the right side of your screen, you'll find a chat window where you can interact with the assistant. Feel free to ask about the content, request suggestions for what to write, pose clarifying questions, and more. The assistant is here to support you as you engage with the material.
                        </Typography>
                    </Box>
                </Grid>
